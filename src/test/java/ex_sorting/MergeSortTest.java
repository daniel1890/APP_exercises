...
class MergeSortTest {
    ...
    void setUp() {
        sut = new MergeSort();
        mergeSorter = new MergeSorter(sut);
    }
    ...
    void UnsortedTestArrayGetsSorted() {
        ...
        // Act
        mergeSorter.sort(unsortedTestArray);
    ...
    void EvenTestArrayGetsSorted() {
        ...
        // Act
        mergeSorter.sort(evenTestArray);
    ...
    void DecliningTestArrayGetsSorted() {
        ...
        // Act
        mergeSorter.sort(decliningTestArray);
    ...
    void GrowingTestArrayGetsSorted() {
        ...
        // Act
        mergeSorter.sort(growingTestArray);
